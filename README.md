...
⚠️🚨⚠️ __Important: Maintaining Personalized Experiences with Machine Learning has been deprecated and will not be receiving any additional features or updates. We encourage customers to explore [Amazon Personalize](https://aws.amazon.com/personalize/) to deliver hyper-personalized user experiences in real-time at scale, improving user engagement, customer loyalty, and business results.__ ⚠️🚨⚠️
